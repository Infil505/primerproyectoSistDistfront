...
async function remove(id) {
  ...
  messageText.value = '🗑️ La ciudad fue enviada a la cola de eliminación.'
    ...
    <ul v-else style="list-style:none;padding:0;display:grid;gap:1rem">
      <li v-for="c in items" :key="c._id"
        ...
        <div style="flex:1;display:grid;gap:.25rem">
          ...
          <div style="color:#6b7280;font-size:.875rem">
            <span style="font-weight:500">Población:</span>
            {{ c.poblacion?.toLocaleString?.('es-ES') || 'N/A' }} habitantes
          </div>
